 ...
 * @since 2018/8/12
 */
public class ZHLinearLayout extends LinearLayout implements IDayNightView{
    public ZHLinearLayout(Context context) {
        super(context);
    }

    public ZHLinearLayout(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public ZHLinearLayout(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
